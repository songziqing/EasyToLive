...
function compareDate() {
   // alert("hello");
     // alert((new Date($("#endDate").val()) - new Date($("#startDate").val()))/86400000);
     // alert($("#room_price").val());
     //  alert((new Date($("#endDate").val()) - new Date($("#startDate").val()))/86400000*$("#room_price").val());
      $("#room_price1").text((new Date($("#endDate").val()) - new Date($("#startDate").val()))/86400000*$("#room_price").val());
     }
(function($){
    stay = {
        start:$('#startDate'),
